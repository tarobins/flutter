...
void main() {
  ...
  testWidgets('ListView itemExtent control test', (WidgetTester tester) async {
    ...
    expect(itemScrollController.itemPositions.value, contains(SliverChildPosition(index: 0, itemLeadingEdge: 0, itemTrailingEdge: 200)));
    expect(itemScrollController.itemPositions.value, contains(SliverChildPosition(index: 1, itemLeadingEdge: 200, itemTrailingEdge: 400)));
    expect(itemScrollController.itemPositions.value, contains(SliverChildPosition(index: 2, itemLeadingEdge: 400, itemTrailingEdge: 600)));
    ...
    expect(itemScrollController.itemPositions.value, contains(SliverChildPosition(index: 1, itemLeadingEdge: 200, itemTrailingEdge: 400)));
    expect(itemScrollController.itemPositions.value, contains(SliverChildPosition(index: 2, itemLeadingEdge: 400, itemTrailingEdge: 600)));
    expect(itemScrollController.itemPositions.value, contains(SliverChildPosition(index: 3, itemLeadingEdge: 600, itemTrailingEdge: 800)));
    expect(itemScrollController.itemPositions.value, contains(SliverChildPosition(index: 4, itemLeadingEdge: 800, itemTrailingEdge: 1000)));
