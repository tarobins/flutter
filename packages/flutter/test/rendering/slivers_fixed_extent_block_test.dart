...
class TestRenderSliverBoxChildManager extends RenderSliverBoxChildManager {
  ...
  RenderSliverFixedExtentList _renderObject;
  List<RenderBox> children;

  RenderSliverFixedExtentList createRenderObject({double itemExtent, ItemPositionCallback itemPositionCallback}) {
    assert(_renderObject == null);
    _renderObject = RenderSliverFixedExtentList(childManager: this, itemExtent: itemExtent, itemPositionCallback: itemPositionCallback);
...
void main() {
  test('RenderSliverFixedExtentList basic test - down', () {
    RenderObject inner;
    RenderBox a, b, c, d, e;
    List<SliverChildPosition> itemPositions;
    ...
    final RenderViewport root = RenderViewport(
      ...
      children: <RenderSliver>[
        inner = childManager.createRenderObject(itemExtent: 400.0, itemPositionCallback: (i) => itemPositions = i),
      ],
    );
    layout(root);
